...
import "../App.css";
import { Authenticate, AddEducation } from "../redux/authentications/authUser";
...
const Education = () => {
  ...
  return (
    <div>
      ...
      <div className="w-full relative mt-4 shadow-2xl text-gray-900 rounded my-24 overflow-hidden">
              ...
              >
                ...
                <div className="form-item">
                  ...
                  <input
                    ...
                    placeholder="Enter your School/University Name here"
                ...
                <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:space-x-4">
                  <div className="form-item w-full">
                    <label className="text-xl ">Degree</label>
                    <input
                      type="text"
                      required
                      name="degree"
                  ...
                  <div className="form-item w-full">
                    <label className="text-xl ">Field of Study</label>
                    <input
                      type="text"
                      name="fieldofstudy"
                      onChange={handleChange}
                ...
                <div className="form-item w-full">
                  <label className="text-xl ">Program Description</label>
                  <textarea
                    rows="2"
                    name="description"
                    onChange={handleChange}
